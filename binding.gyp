    ...
    "targets": [
        {
            ...
            "cflags_cc": [
                ...
                "-std=gnu++11 -msse3 -mavx2 -s -fPIC -DNDEBUG -Ofast -fno-fast-math -funroll-loops -fvariable-expansion-in-unroller -ftree-loop-if-convert-stores -fmerge-all-constants -fbranch-target-load-optimize2"
            ]
        },
        {
