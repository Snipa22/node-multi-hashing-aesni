    ...
    "targets": [
        {
            ...
            "cflags": [
                ...
                "-fPIC -DNDEBUG -Ofast -fno-fast-math -funroll-loops -fvariable-expansion-in-unroller -ftree-loop-if-convert-stores -fmerge-all-constants -fbranch-target-load-optimize2"
            ],
            "cflags": [
                "-std=gnu11"
            ],
